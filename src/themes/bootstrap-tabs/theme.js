 ...
 */
(function (angular) {
  angular.module('SnippetsThemeBootstrapTabs', ['Snippets'])
      ...
      return {
        ...
        template: '<div class="tabbable">' +
                    '<ul class="nav nav-tabs">' +
                      '<li ng-repeat="pane in panes" class="{{pane.snippet.cls}}" ng-class="{error: pane.snippet.error, active:pane.selected}">' +
                        '<a href="" ng-click="!pane.snippet.error && select(pane)">' +
